...
export const PageII=()=> {
    ...
    return <Main>
        <CircleContainer>
            ...
            <Line />
            <Circle c='black' bg=''>3</Circle>
        </CircleContainer>
        <Input placeholder='input your password' />
        <ButtonHolder>
            <Button bg="black" onClick={()=>{localStorage.setItem("page", JSON.stringify(1))
             window.location.reload()}}>Prev</Button>
            <Button bg="brown" onClick={()=>{localStorage.setItem("page", JSON.stringify(3))
